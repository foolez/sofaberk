# -*- coding: utf-8 -*-
"""TAKIM TUT — takım veritabanının kaynağı.

Bu dosyayı düzenle, sonra:  python3 tools/takim-uret.py
komutu assets/js/teams.js içindeki listeyi yeniden yazar.

Satır düzeni:
  (id, ad, kısa, şehir, lig, kuruluş, renk1, renk2, desen, grup, bayrak)
    desen  : stripes | hoops | halves | sash | solid
    bayrak : s=deniz kenarı şehir  b=başkent  a=Avrupa/kıta kupası var
"""
